...
System.out.println("====================================== parameters:start =================================================");
		System.out.println("accFile:"+accFile);
		System.out.println("outputFile:"+outputFile);
		System.out.println("rawOutputFile:"+rawOutputFile);
		System.out.println("npyOutputFile:"+npyOutputFile);
		System.out.println("rawOutput:"+rawOutput);
		System.out.println("fftOutput:"+fftOutput);
		System.out.println("npyOutput:"+npyOutput);
		
		System.out.println("epochPeriod:"+epochPeriod);
		System.out.println("timeFormat:"+timeFormat);
		System.out.println("csvTimeFormat:"+csvTimeFormat);
		System.out.println("getEpochCovariance:"+getEpochCovariance);
		System.out.println("getAxisMeans:"+getAxisMeans);

		System.out.println("getStationaryBouts:"+getStationaryBouts);
		System.out.println("stationaryStd:"+stationaryStd);
		System.out.println("swIntercept:"+swIntercept);
		System.out.println("swSlope:"+swSlope);
		System.out.println("tempCoef:"+tempCoef);
		
		System.out.println("meanTemp:"+meanTemp);
		System.out.println("range:"+range);
		System.out.println("sampleRate:"+sampleRate);
		System.out.println("useFilter:"+useFilter);
		System.out.println("startTime:"+startTime);
		
		System.out.println("endTime:"+endTime);
		System.out.println("getSanDiegoFeatures:"+getSanDiegoFeatures);
		System.out.println("getMADFeatures:"+getMADFeatures);
		System.out.println("getUnileverFeatures:"+getUnileverFeatures);
		System.out.println("get3DFourier:"+get3DFourier);
		
		System.out.println("getEachAxis:"+getEachAxis);
		System.out.println("useAbs:"+useAbs);
		System.out.println("numEachAxis:"+numEachAxis);
		System.out.println("csvStartTime:"+csvStartTime);
		System.out.println("csvSampleRate:"+csvSampleRate);
		
		System.out.println("csvStartRow:"+csvStartRow);
		System.out.println("csvXYZTCols:"+csvXYZTCols);
		System.out.println("useFilter:"+useFilter);
		System.out.println("csvTimeFormat:"+csvTimeFormat);
